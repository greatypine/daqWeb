(function ($, undefined) {
    ...
    function focusable(element, isTabIndexNotNaN) {
        ...
        return (/input|select|input|button|object/.test(nodeName) ? !element.disabled : "a" === nodeName ? element.href || isTabIndexNotNaN : isTabIndexNotNaN) && visible(element)
    }
...
(function ($, undefined) {
    ...
    $.widget("ui.mouse", {
        version: "1.9.2",
        options: {cancel: 'input,input,button,select,option', distance: 1, delay: 0},
        _mouseInit: function () {
            var that = this;
...
(function ($, undefined) {
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            this.valueMethod = this.element[this.element.is("input,input") ? "val" : "text"];
            this.isNewMenu = true;
...
(function ($, undefined) {
    ...
    $.extend($.ui.dialog, {
        uuid: 0, maxZ: 0, getTitleId: function ($el) {
            var id = $el.attr("id");
            if (!id) {
                this.uuid += 1;
                id = this.uuid
...
(jQuery.effects || (function ($, undefined) {
    ...
    (function () {
        $.extend($.effects, {
            version: "1.9.2", save: function (element, set) {
...
(function ($, undefined) {
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this.element[0].nodeName.match(/canvas|input|input|select|button|img/i)) {
            ...
            this._renderAxis = function (target) {
                ...
                for (var i in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/input|input|select|button/i)) {
        ...
        _mouseStop: function (event) {
            ...
            if (this._helper) {
                var pr = this._proportionallyResizeElements, ista = pr.length && (/input/i).test(pr[0].nodeName), soffseth = ista && $.ui.hasScroll(pr[0], 'left') ? 0 : that.sizeDiff.height, soffsetw = ista ? 0 : that.sizeDiff.width;
                var s = {
    ...
    $.ui.plugin.add("resizable", "animate", {
        stop: function (event, ui) {
            var that = $(this).data("resizable"), o = that.options;
            var pr = that._proportionallyResizeElements, ista = pr.length && (/input/i).test(pr[0].nodeName), soffseth = ista && $.ui.hasScroll(pr[0], 'left') ? 0 : that.sizeDiff.height, soffsetw = ista ? 0 : that.sizeDiff.width;
            var style = {
