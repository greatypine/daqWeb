...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.locale === 'object') {
             ...
             * 以下为添加内容；及79行iscity
             */
            if (typeof options.locale.iscity === 'number'){
            	this.locale.iscity = options.locale.iscity;
            }
        }
    ...
    DateRangePicker.prototype = {
    	/**
    	 * TODO
    	 * 添加了一个setLocale iscity 函数，用来判断是否是门店
    	 * @param iscity
    	 */
    	setLocale : function(iscity){
    		this.locale.iscity = iscity;
    	},
        ...
        clickDate: function(e) {
            ...
            if (this.endDate || date.isBefore(this.startDate, 'day')) { //picking start
                ...
                /**
                 * TODO 
                 * 此行做修改，无论结束日期选那一天，默认都是开始时间
                 */
                if(this.locale.iscity == 1){
                	...
                	if (this.timePicker) {
	                    ...
	                    var minute = parseInt(this.container.find('.right .minuteselect').val(), 10);
	                    var second = this.timePickerSeconds ? parseInt(this.container.find('.right .secondselect').val(), 10) : 0;
	                    date = this.startDate.clone().hour(hour).minute(minute).second(second);
                	}
