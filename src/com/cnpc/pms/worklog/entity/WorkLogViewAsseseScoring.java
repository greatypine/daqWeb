...
@Entity
@Table(name = "view_worklog_assessscoring")

public class WorkLogViewAsseseScoring implements IEntity{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5151779943788146184L;
	@Id
	@Column(name = "id")
	private Long id;
