...
public class StoreActivitiesDaoImlp extends BaseDAOHibernate implements StoreCoverPersonDao{

	@Override
	public List<Map<String, Object>> getStoreCoverPerson() {
		String sql = "select COUNT(DISTINCT cityname) as count from t_store_cover_person";
		...
		String str_sql = "select * from t_store_cover_person where WEEKOFYEAR(create_time) = WEEKOFYEAR(NOW()) ORDER BY create_time DESC limit "+count;
