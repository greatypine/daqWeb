	...
	public Map<String, Object> exportUserProfile(UserProfileDto userProfile){
		...
		Map<String, Object> result = new HashMap<String,Object>();
  		...
  		if(list!=null&&list.size()>0){//成功返回数据
  	        ...
  	        //定义表头 以及 要填入的 字段 
  	        String[] str_headers = {"用户姓名","用户电话","历史消费金额","历史消费次数","最大交易金额","首次消费时间","最后消费时间","沉默时间（天）","消费片区","有无画像","用户标签"};
  	        String[] headers_key = {"customer_name","customer_phone","trading_price_sum","order_count","trading_price_max","first_order_time","last_order_time","slient_time","area_code","user_model","usertag"};
