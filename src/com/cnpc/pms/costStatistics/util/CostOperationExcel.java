...
public class CostOperationExcel {
    ...
    private final String[] header0 = { "序号","门店编码","门店名称","月度运营成本","日常办公","仓储型星店房租","桶装水","门店保险","电动车维修费用","购物袋","垃圾袋","灭火器","车载包+背包","头盔+护膝+手套","绿植","托盘","仓储物资（周转箱、人字梯、拖车等）","门店营销活动费","门店装修及设备维修"};//在excel中的第2行每列的参数
    ...
    private final String[] colName = new String[] { "store_no", "store_name", "month_charge", "daily_office", "rent","barrelled_water","store_insurance", "car_maintain", "shopping_bag","garbage_bag","extinguisher", "backpack", "helmet","greenPlants","tray", "storage_materials", "activity_fee","decoration_maintain" };//需要显示在excel中的参数对应的值，因为是用map存的，放的都是对应的key
    ...
    public Map<String,Object> exportFile(){
        ...
        String fileName_part = utilityManager.getPYIndexStr("日常运营",true);
        // 如果目录不存在则创建
        ...
        HSSFSheet sheet = workbook.createSheet("日常运营");
