       ...
       // 设置列值-内容
        for (int i = 0; i < data.size(); i++) {
            ...
            for (int j = 0; j < colName.length; j++) {
                ...
                cell.setCellType(HSSFCell.CELL_TYPE_STRING);
                cell.setCellValue(new HSSFRichTextString(data==null?null:data.toString()));
                if(j<2){
                    cell.setCellStyle(fixedStyle);
                }else{
