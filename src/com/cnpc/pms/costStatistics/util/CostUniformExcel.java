 ...
 * @Description:
 * @Author: gbl
 * @CreateDate: 2018/9/27 13:10
 */
public class CostUniformExcel {
    ...
    public CostUniformExcel(List<Map<String,Object>> data){
        this.data = data;
    }
    //导出的文件标题
    private final String[] header0={"序号","门店编码","门店名称","工服年费","工服摊销"};

    private final String[] colName = new String[] { "store_no", "store_name","uniform_charge","uniform_amortize"};
    ...
    public Map<String,Object> exportFile(){
        ...
        String fileName_part = utilityManager.getPYIndexStr("工服年费",true);
        // 如果目录不存在则创建
        ...
        HSSFSheet sheet = workbook.createSheet("工服年费");
